...
async function main() {
  ...
  try {
    ...
    check(
      "service 2 self-pickup pickupSlots come from pickup_start/return_by (09:00-17:00) at the hourly (60 min) interval, not the delivery pickup window (14:00-16:00)",
