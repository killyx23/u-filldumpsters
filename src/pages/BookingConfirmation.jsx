import React, { useState, useEffect, useRef, useCallback } from 'react';
    ...
    import { CheckCircle, Home, Calendar, Mail, DollarSign, User, Phone, MapPin, Clock, Loader2, AlertTriangle, XCircle, Printer, Truck, Key } from 'lucide-react';
      ...
      const fetchBookingDetails = useCallback(async (sessionId, attempt = 1) => {
        ...
        try {
          ...
          if (bookingError || (bookingData && bookingData.error)) {
            ...
            if (errorMessage.includes('Could not find a booking') && attempt < 12) {
