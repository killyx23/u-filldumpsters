...
const ServiceCard = ({
  ...
  let imageUrl = "";
  if (id === 1) {
    imageUrl = "https://horizons-cdn.hostinger.com/084723fe-37cf-40b6-bc10-548f6485382e/ab93b9ab311fb0efb03f5a24f0c97ada.jpg";
  } else if (id === 2) {
    imageUrl = "https://horizons-cdn.hostinger.com/084723fe-37cf-40b6-bc10-548f6485382e/71ba93b0b17b71051b7ab08600b18632.jpg";
  } else if (id === 3) {
    imageUrl = "https://horizons-cdn.hostinger.com/084723fe-37cf-40b6-bc10-548f6485382e/d690552d16c0ca79c2f9b31cc3dd1aa0.png";
  }
  return <motion.div initial={{
    ...
    duration: 0.5,
    delay
  }} onClick={() => onClick(id)} className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg border border-white/20 text-center flex flex-col h-full overflow-hidden group cursor-pointer">
...
export const Hero = () => {
    ...
    const fetchServices = async () => {
      ...
      try {
        ...
        const {
          data,
          error
        } = await supabase.from('services').select('id, name').in('id', [1, 2, 3]).order('id');
        if (error) {
  ...
  return <section className="py-24 text-center relative overflow-hidden min-h-[80vh] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {loading ? <div className="flex justify-center items-center h-64">
            ...
            {services.map((service, index) => <ServiceCard key={service.id} id={service.id} name={service.id === 3 ? "Rock, Decorative Rock, Mulch, & Gravel Delivery Service" : service.name} delay={0.4 + index * 0.15} onClick={scrollToService} />)}
          </div>}
      </div>
    </section>;
};