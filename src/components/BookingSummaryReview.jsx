...
export const BookingSummaryReview = ({
    ...
    // Safely extract string properties to prevent React render crashes
    const planName = plan?.name || 'Selected Plan';
    const displayPlanName = isDelivery ? `${planName} (with Delivery)` : planName;

    // Correctly reference the structured address from bookingData to prevent object rendering
