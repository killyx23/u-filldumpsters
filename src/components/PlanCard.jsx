...
export const PlanCard = ({ plan, onSelect, isTemporarilyUnavailable }) => {
    ...
    const cardStyles = {
        1: {
            ...
            title: 'text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500',
        ...
        2: {
            ...
            title: 'text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-blue-400',
        ...
        3: {
            ...
            title: 'text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-400',
    ...
    const displayDescription = plan.homepageDescription || plan.description;
    const displayPrice = plan.homepagePrice !== undefined ? plan.homepagePrice : plan.price;
    const displayPriceUnit = plan.homepagePriceUnit || plan.priceUnit;
        ...
        <>
            ...
            >
                ...
                <div className={cn(
                    ...
                    <div className={cn(
                        "relative z-10 backdrop-blur-xl rounded-[9px] p-6 flex flex-col h-full",
                        currentStyle.bg,
                        ...
                        <div className="flex-grow pt-8">
                            <h3 className={cn("text-3xl font-bold mb-3 text-center", currentStyle.title)} style={{textShadow: '0 2px 10px rgba(0,0,0,0.5)'}}>{plan.name}</h3>
