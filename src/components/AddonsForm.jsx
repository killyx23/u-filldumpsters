...
export const AddonsForm = ({ basePrice, addonsData, setAddonsData, onSubmit, onBack, plan, deliveryService }) => {
  ...
  const calculateTotal = useCallback(() => {
    ...
    let newTotal = plan.base_price;
    
    if (addonsData.insurance === 'accept') {
      newTotal += addonPrices.insurance;
    }
    if (addonsData.drivewayProtection === 'accept' && plan.id !== 2) {
    ...
    if (addonsData.distanceInfo?.totalFee > 0) {
        newTotal += addonsData.distanceInfo.totalFee;
    }
    ...
    if (addonsData.coupon && addonsData.coupon.isValid) {
      if (addonsData.coupon.discountType === 'fixed') {
        ...
        newTotal *= (1 - addonsData.coupon.discountValue / 100);
      }
    }
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <OrderSummary
                  plan={{...plan, price: plan.base_price}}
                  addons={addonsData}
