...
const ReviewCard = ({ review, onReadMore }) => {
    ...
    const displayTitle = review.title || 'Great Service!';
        ...
        >
            ...
            {hasMedia && (
                <ReviewMediaDisplay
                    ...
                    maxImages={3}
                    className="mt-3"
                    imageClassName="h-14 w-14 rounded-md object-cover border border-white/20"
                    videoClassName="w-full max-h-28 rounded-md border border-white/20"
                />
            )}
