    ...
    return (
        <div ref={ref} className="p-8 font-sans text-gray-800 bg-white">
            ...
            <section>
             ...
             {isPendingReview && (
                <section className="mt-4 p-4 bg-orange-50 border border-orange-200 rounded-md">
                    <h3 className="font-bold text-lg mb-2 text-orange-800">Your Order is Being Held for Manual Review</h3>
                </section>
             )}
            {plan.id === 2 && !isCancelledAndRefunded && !isPendingReview && (
                <section className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
             ...
             {isCancelledAndRefunded && (
                <section className="mt-6 p-4 bg-red-50 border border-red-200 rounded-md">
                    <h3 className="font-bold text-lg mb-2 text-red-800">Cancellation Details</h3>
                    <p className="text-sm text-gray-700"><strong>Reason:</strong> {refund_details.reason}</p>
                    <p className="text-sm text-gray-700"><strong>Stripe Refund ID:</strong> {refund_details.refund_id}</p>
                </section>
            )}
            {addons.notes && (
             ...
             <footer className="text-xs text-gray-500 pt-4 mt-6 border-t">
