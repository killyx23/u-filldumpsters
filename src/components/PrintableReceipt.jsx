                    ...
                    <section style={{ pageBreakInside: 'avoid' }}>
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                ...
                                {mattressDisposalCount > 0 && (
                                    <tr className="border-b"><td className="py-2 pl-4">Mattress Disposal (x{mattressDisposalCount})</td><td className="text-right py-2">${(25 * mattressDisposalCount).toFixed(2)}</td></tr>
                                )}
                                {tvDisposalCount > 0 && (
                                    <tr className="border-b"><td className="py-2 pl-4">TV Disposal (x{tvDisposalCount})</td><td className="text-right py-2">${(15 * tvDisposalCount).toFixed(2)}</td></tr>
                                )}
                            </tbody>
                            <tfoot>
