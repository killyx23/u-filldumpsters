                  ...
                  {plan.id === 2 && (
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="ghost" size="icon" className="ml-2 text-red-500 hover:text-red-600 relative">
                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                          <Info className="h-6 w-6 relative" />
                        </Button>
                      </TooltipTrigger>
