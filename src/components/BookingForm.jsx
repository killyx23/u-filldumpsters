...
import { format, startOfDay, isBefore, parse, formatISO, startOfMonth, endOfMonth, isValid, addDays } from 'date-fns';
...
export const BookingForm = ({
  ...
  }, [isDelivery, setBookingData, plan.id, deliveryService]);
