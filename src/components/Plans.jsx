...
export const Plans = ({ onSelectPlan }) => {
    ...
    // Older homepage layout: one responsive grid for all cards. Service groups still
    // drive fetch order (group_display_order); we do not wrap each group in its own
    // grid — that stacked single-card sections vertically.
    const gridClass =
