    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center summary-item">
          <span className="text-blue-200">Base Rental Price</span>
        ...
        {(addons?.mattressDisposal > 0 || addons?.tvDisposal > 0 || addons?.applianceDisposal > 0) && (
          <div>
            ...
            <ul className="space-y-1 pl-4">
              {addons?.mattressDisposal > 0 && (
                <li className="flex justify-between text-sm summary-item">
                  <span className="text-gray-300">Mattress Disposal x{addons.mattressDisposal}</span>
                  <span className="text-green-400">{formatCurrency(25 * addons.mattressDisposal * 100)}</span>
                </li>
              )}
              {addons?.tvDisposal > 0 && (
                <li className="flex justify-between text-sm summary-item">
                  <span className="text-gray-300">TV Disposal x{addons.tvDisposal}</span>
