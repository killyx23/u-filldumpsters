-- Allow pre-verified returning customers to skip Step 8 email verification.
-- When payload.email_preverified is true, verify email_verifications.is_verified server-side.
