-- Ensure store_pending_booking updates the deterministic row when multiple
-- case-variant emails exist (e.g. Brandon@... and brandon@...).
-- This avoids unique collisions when normalizing email to lowercase.
