  ...
  public: {
    Tables: {
      ai_assistant_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_assistant_messages_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
      ...
      ai_knowledge_base: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_knowledge_base_section_id_fkey"
            columns: ["section_id"]
            isOneToOne: false
            referencedRelation: "ai_knowledge_sections"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      bookings: {
        Row: {
          ...
          pin_notification_sent_at: string | null
          plan: Json
      ...
      referrals: {
        ...
        Relationships: [
          {
            foreignKeyName: "referrals_completed_booking_id_fkey"
      ...
      rental_access_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "rental_access_codes_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
      ...
      rental_tracking_logs: {
        Row: {
          api_sync_timestamp: string | null
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "rental_tracking_logs_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
      ...
      services: {
        Row: {
          ...
          delivery_fee: number | null
          delivery_fee_is_taxable: boolean
          description: string | null
          features: Json | null
      ...
      tax_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "tax_records_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      upsert_pending_customer: {
        Args: {
          p_addons_data: Json
          p_booking_data: Json
          p_city: string
          p_contact_address: Json
          p_delivery_address: Json
          p_drop_off_date: string
          p_drop_off_time_slot: string
          p_email: string
          p_first_name: string
          p_last_name: string
          p_notes: string
